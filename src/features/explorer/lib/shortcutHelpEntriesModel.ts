...
} from '../../../config/shortcutActionCatalog.ts'
import {
  formatShortcutBindingsForDisplay,
} from '../../../config/shortcutBindingDisplay.ts'
import type {
  ShortcutBinding,
...
export interface ShortcutHelpGlobalTagOptionsState {
  status: 'idle' | 'loading' | 'ready'
  error: string | null
}

export interface ShortcutHelpDigitAssignment {
  fieldKey: string
  valueByDigit: Record<string, string>
}

export interface ShortcutHelpPreviewTagShortcut {
  actionId: string
  key: string
  value: string
  tagKey: string
...
export interface ResolveShortcutHelpEntriesParams {
  keyboardShortcuts: KeyboardShortcuts
  configuredPreviewTagShortcuts: readonly ShortcutHelpPreviewTagShortcut[]
  availableTagKeys: ReadonlySet<string>
  globalTagOptionsState: ShortcutHelpGlobalTagOptionsState
  digitAssignment: ShortcutHelpDigitAssignment | null
  currentPath: string
...
export function resolveShortcutHelpEntries({
  keyboardShortcuts,
  ...
  canManagePreviewTags,
  canSoftDeletePreview,
}: ResolveShortcutHelpEntriesParams): ShortcutHelpEntry[] {
